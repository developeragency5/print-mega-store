...
import heroBanner1 from "@assets/banner-1_1768350551634.jpg";
import heroBanner2 from "@assets/banner-2_1768350551634.jpg";
...
import inkjetIcon from "@assets/printer_(2)_1768414176696.png";
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-12 bg-gray-50 sm:py-16 lg:py-20" data-testid="trust-section">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex flex-col items-center">
            <div className="text-center">
              <p className="text-lg font-medium text-gray-600">Why Shop With Us</p>
              ...
              <div className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                ...
                >
                  <div className="p-6 bg-white rounded-xl shadow-md flex flex-col h-full">
                    ...
                    <div className="text-sm leading-relaxed text-gray-600 space-y-4 flex-grow">
                      <p>
